...
Enhanced by:
    ...
    RecursionBane
    <https://github.com/recursionbane>
`
	fmt.Printf(s)
	os.Exit(0)
}
...
func LoadConfig() {
	...
	flag.BoolVar(&Config.ListDirAsJSON, "listdirasjson", false, "Show file list of a directory as JSON")
	flag.StringVar(&Config.IgnoreFileExt, "ignorefileext", "", "Extensions to ignore (CSV)")
